class WordSequence:
    ...
    def execute():
        ...
        for i in range(1, len(word_sequence)-1):
            ...
            #(context, target)
            # 스킵그램을 만든 후, 저장은 단어의 고유번호로(index) 한다.
            for W in context:
        ...
        num_sampled = 15 # 모델 학습에 사용할 샘플의 크기. batxh_size 보다는 작아야함
        ...
        # embedding vector의 차원에서 학습할 입력값에 대한 행동을 뽑아옵니다
        ...
        train_op = tf.train.AdamOptimizer(learnubg_rate).minimize(loss)
        ...
        with tf.Session() as sess:
            ...
            for step in range(1, training_epoch  + 1):
                ...
                # with 구문안에서 sess.run 대신에 간단히 eval() 함수를 사용해서 저장할 수 있다
